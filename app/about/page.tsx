      ...
      <section>
        <div className="container">
          ...
          <div className="row mt-10">
            <div className="basis-full md:basis-1/2 2xl:basis-1/4 ">
              <div className="flex-center h-full shadow-md border-solid border-4 rounded-lg m-2 border-primary p-6 text-center duration-300 hover:-translate-y-2">
            ...
            <div className="basis-full md:basis-1/2 2xl:basis-1/4 ">
              <div className="flex-center h-full shadow-md border-solid border-4 rounded-lg m-2 border-primary p-6 text-center duration-300 hover:-translate-y-2">
                ...
                <p>
                  We pride ourselves on delivering a seamless shopping
