...
const DeleteCategory = ({ slug }: { slug: string }) => {
    ...
    <div className="flex flex-col items-center justify-center">
      ...
      <Modals isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
        ...
        <p className="mb-4 text-lg text-left">
          Are you sure you want to delete this category ? This action remove this category in all products and cannot be
          undone .
        </p>
        ...
        {error && (
          <div role="alert" className="alert alert-error mt-5">
            <MdError size={30} />
            <span>This category cannot be deleted .</span>
            <button
