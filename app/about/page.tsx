      ...
      <section>
        <div className="container">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 mt-10">
            <div className="flex-center h-full shadow-md border-solid border-4 rounded-lg m-2 border-primary p-6 text-center duration-300 hover:-translate-y-2 hover:rounded-3xl">
